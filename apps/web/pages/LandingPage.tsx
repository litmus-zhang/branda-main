...
import { Sparkles, Briefcase, Globe, PenTool, Star, Check, Facebook, Twitter, Instagram, Linkedin } from 'lucide-react';
            ...
            <CardContent className="p-6 md:p-8">
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <Button
                  type="submit"
                  size="lg"
                  className="w-full py-7 text-lg bg-primary-600 hover:bg-primary-700 shadow-lg hover:shadow-primary-500/30 transition-all transform hover:-translate-y-0.5"
                >
