...
export const LandingPage: React.FC = () => {
  ...
  return (
    <PageLayout fullWidth className="font-sans pt-20">

      {/* Hero Section */}
      <section className="relative overflow-hidden bg-white">
        {/* Full-bleed background for the right side on desktop */}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="flex flex-col md:flex-row min-h-[calc(100vh-80px)]">
            {/* Left Content */}
            <div className="flex-1 py-12 md:py-24 flex flex-col justify-center pr-0 md:pr-12">
            ...
            <div id="testimonials" className="hidden md:flex md:w-1/2 items-center justify-center pl-12">
